...
python -c "import pyaudio; print('   ✓ PyAudio available')" 2>&1 || log_warning "   ⚠  PyAudio not available (text mode will be used)"
python -c "import pygame; print(f'   ✓ Pygame: {pygame.version.ver}')" 2>&1 || log_warning "   ⚠  Pygame not available (optional - only needed for audio playback)"
